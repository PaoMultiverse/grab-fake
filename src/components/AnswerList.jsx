...
function AnswerList(){
    return (
        <>
            <h5>Làm cách nào để đặt đồ ăn ở Việt Nam?</h5>
            <div className="answer my-[30px] border-b border-solid border-gray-300">
                ...
                <ol>
                    ...
                    <li>
                        <strong>Giao hàng</strong> - GrabFood đã thiết kế một hành trình phục vụ khách hàng liền mạch để bạn có thể thưởng thức món ăn một cách trọn vẹn. Chúng tôi sẽ gửi cho bạn email và tin nhắn SMS tức thời xác nhận đơn đặt hàng của bạn và thời gian giao hàng dự kiến. Sau đó chúng tôi sẽ giao ngay đồ ăn cho bạn.
                    </li>
                </ol>
            </div>
        </>
